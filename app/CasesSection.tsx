...
const caseStudies: CaseStudy[] = [
  {
    ...
    proofs: [
      { title: "Затраты · 2024", src: "/education-ads-2024.webp", alt: "Скриншот рекламных расходов за 2024 год", amount: "$48 091", label: "рекламные расходы" },
      { title: "Затраты · 2025", src: "/education-ads-2025.webp", alt: "Скриншот рекламных расходов за 2025 год", amount: "$66 902", label: "рекламные расходы" },
      { title: "Затраты · 2026 · январь–июнь", src: "/education-ads-2026.webp", alt: "Скриншот рекламных расходов за январь–июнь 2026 года", amount: "$67 182", label: "рекламные расходы" },
    ],
  },
  {
    id: "football",
  ...
  },
  {
    ...
    work: [],
    proofs: [
      { title: "", src: "/jewelry-ads-proof-blurred.webp", alt: "Анонимизированный скриншот рекламного кабинета ювелирного бренда", caption: "Скриншот рекламного кабинета" },
    ],
  },
  {
    id: "kindergarten",
